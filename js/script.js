...
// const lyricsData = [
//     { time: 0, text: "HO..." },
//     { time: 3, text: "APNE HI RANG MEIN" },
//     { time: 5, text: "MUJHKO RANG DE" },
//     { time: 10, text: "DHEEME-DHEEME" },
//     { time: 12, text: "RANG MEIN" },
//     { time: 19, text: "MUJHKO RANG DE" },
//     { time: 20, text: "SAUNDHE-SAUNDHE" },
//     { time: 21, text: "RANG MEIN"},
//     { time: 22.5, text: "MUJHKO RANG DE" },
//     { time: 23.5, text: "RANG DE NA," },
//     { time: 26, text: "RANG DE NAA" },
//     { time: 27.5, text: "RANG DE NAAA..." }
//   ];
